...
type AlertInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/justtrackio/provider-clickhouse/apis/cluster/clickstack/v1alpha1.SavedSearch
	...
	// +crossplane:generate:reference:type=github.com/justtrackio/provider-clickhouse/apis/cluster/clickstack/v1alpha1.Team
...
type ChannelInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/justtrackio/provider-clickhouse/apis/cluster/clickstack/v1alpha1.Webhook
