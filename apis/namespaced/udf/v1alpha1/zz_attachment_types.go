...
type AttachmentObservation struct {
	...
	// (String) ID of the attached service.
...
type AttachmentParameters struct {
	...
	// (String) Name of the UDF.
	// Name of the UDF.
	// +crossplane:generate:reference:type=github.com/justtrackio/provider-clickhouse/apis/namespaced/udf/v1alpha1.Function
	// +kubebuilder:validation:Optional
	FunctionName *string `json:"functionName,omitempty" tf:"function_name,omitempty"`

	// Reference to a Function in udf to populate functionName.
	// +kubebuilder:validation:Optional
	FunctionNameRef *v2.NamespacedReference `json:"functionNameRef,omitempty" tf:"-"`

	// Selector for a Function in udf to populate functionName.
	// +kubebuilder:validation:Optional
