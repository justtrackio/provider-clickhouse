...
type AlertInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/justtrackio/provider-clickhouse/apis/namespaced/clickstack/v1alpha1.SavedSearch
	...
	SavedSearchIDRef *v2.NamespacedReference `json:"savedSearchIdRef,omitempty" tf:"-"`

	// Selector for a SavedSearch in clickstack to populate savedSearchId.
	// +kubebuilder:validation:Optional
	SavedSearchIDSelector *v2.NamespacedSelector `json:"savedSearchIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/justtrackio/provider-clickhouse/apis/namespaced/clickstack/v1alpha1.Team
...
type ChannelInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/justtrackio/provider-clickhouse/apis/namespaced/clickstack/v1alpha1.Webhook
	...
	// +kubebuilder:validation:Optional
	WebhookIDRef *v2.NamespacedReference `json:"webhookIdRef,omitempty" tf:"-"`

	// Selector for a Webhook in clickstack to populate webhookId.
	// +kubebuilder:validation:Optional
	WebhookIDSelector *v2.NamespacedSelector `json:"webhookIdSelector,omitempty" tf:"-"`
}
