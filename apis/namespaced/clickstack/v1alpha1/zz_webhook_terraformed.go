...
func (mg *Webhook) GetTerraformResourceType() string {
	return "clickhouse_clickstack_webhook"
}

// GetConnectionDetailsMapping for this Webhook
func (tr *Webhook) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"body": "bodySecretRef", "headers": "headersSecretRef", "query_params": "queryParamsSecretRef", "url": "urlSecretRef"}
}
